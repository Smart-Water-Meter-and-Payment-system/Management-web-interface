package org.pahappa.systems.ppms.backend.core.utils;
...
public class CustomSearchUtils {
    ...
    public static Search genereateSearchObjectForProjects(String searchTerm, SortField sortField) {
    ...
    public static Search genereateSearchObjectForModules(String searchTerm, SortField sortField) {
        Search search = generateSearchTerms(searchTerm, Arrays.asList("name", "description", "project.name"));
        if (sortField != null) {
            search.addSort(sortField.getSort());
        } else {
            search.addSort(new Sort("dateCreated", true));
    ...
    public static Search genereateSearchObjectForSubmodules(String searchTerm, SortField sortField) {
        Search search = generateSearchTerms(searchTerm, Arrays.asList("name", "description", "module.name"));
    ...
    public static Search genereateSearchObjectForTasks(String searchTerm, SortField sortField) {
        Search search = generateSearchTerms(searchTerm, Arrays.asList("name", "description", "submodule.name"));
	...
	public static Search generateSearchObjectForProjectTypes(String searchTerm, SortField sortField) {
		Search search = generateSearchTerms(searchTerm, Arrays.asList("name", "description"));
		if (sortField != null) {
			search.addSort(sortField.getSort());
		} else {
