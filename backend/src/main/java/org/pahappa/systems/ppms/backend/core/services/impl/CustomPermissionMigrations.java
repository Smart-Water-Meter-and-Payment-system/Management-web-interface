...
import org.pahappa.systems.ppms.backend.models.security.PPMSPermissionInterpreter;
...
public class CustomPermissionMigrations {
	...
	public void savePermissions() {
            ...
            for (Permission permission : PPMSPermissionInterpreter.reflectivelyGetPermissions()) {
