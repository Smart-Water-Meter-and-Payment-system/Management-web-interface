...
import org.swamp.backend.core.services.MailSettingService;
...
public class CustomApplicationSettings extends DefaultApplicationSettings {
	...
	public static final String BG_JOBS_CHECKSUM = "SWAMP";
	...
	public List<String> getErrorMessageRecipients() {
		return Arrays.asList(new String[] {"golderalikaya@gmail.com" });
	}
	@Override
	...
	public String getDefaultSuperUserEmail() {
		return "golderalikaya@gmail.com";
	}
	@Override
