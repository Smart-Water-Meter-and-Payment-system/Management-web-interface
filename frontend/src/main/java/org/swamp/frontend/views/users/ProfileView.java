...
public class ProfileView extends WebFormView<User, ProfileView, ProfileView> {
    ...
    private String customPropOneString;
...
//    }
    ...
    public void saveUser() {
        try {
        	this.customPropOneString = Integer.toString(this.customPropOneNumber);
        	super.model.setCustomPropOne(customPropOneString);
            this.userService.saveUser(super.getModel());
            FacesMessage msg = new FacesMessage("Success", "SwampUser updated");
...
//                    "secure", true));
	...
	public String getCustomPropOneString() {
		return customPropOneString;
	}

	public void setCustomPropOneString(String customPropOneString) {
		this.customPropOneString = customPropOneString;
	}
